...
module.exports = function(args, resolve) {
  ...
  console.log(`# fixtures: ${args.fixtures}`);
  console.log();
  ...
  try {
    child_process.execSync(
      `git archive ${args.ref} ${scriptName} ${args.fixtures.join(' ')} -o ${compareArchive}`,
      {
    ...
    console.error(`Error downloading compare plugin script: ${e.message}`);
    return;
  }
