...
const schemaProperties = require(`./schema-properties.mjs`).default;
const { checkFixture } = require(`../tests/fixture-valid.js`);
const { CoarseChannel } = require(`./model.js`);
...
module.exports = function getOutObjectFromEditorData(fixtures) {
  out = {
    manufacturers: {},
    fixtures: {},
    submitter: null,
