...
module.exports = class SwitchingChannel extends AbstractChannel {
  ...
  /**
   * @return {!string[]} All channel keys this channel can be switched to.
   */
  ...
  /**
   * @return {!Array.<AbstractChannel, MatrixChannel>} All channels this channel can be switched to.
   */
   ...
   * @return {!boolean} Whether this SwitchingChannel contains the given channel key.
   */
