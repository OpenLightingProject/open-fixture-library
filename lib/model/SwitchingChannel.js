...
module.exports = class SwitchingChannel extends AbstractChannel {
  ...
  // returns an array of channels to which this channel can be switched
  ...
  /*
   * `where` can be one of 'keyOnly', 'defaultOnly', 'switchedOnly', 'all' (default)
   */
  containsChannelKey(chKey, where) {
    if (where === 'keyOnly') {
