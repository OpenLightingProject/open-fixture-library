...
class Physical {
  ...
  /**
   * @returns {?number} Power consumption of the fixture in watts. Defaults to null.
   */
  get power() {
  ...
  /**
   * @returns {?number} The color temperature of the bulb in kelvins. Defaults to null.
   */
  ...
  /**
   * @returns {?number} The maximum angle in degrees that this fixture can rotate in horizontal direction (Pan). `Number.POSITIVE_INFINITY` if continuous pan is possible. Defaults to null.
   */
  get focusPanMax() {
  ...
  /**
   * @returns {?number} The maximum angle in degrees that this fixture can rotate in vertical direction (Tilt). `Number.POSITIVE_INFINITY` if continuous pan is possible. Defaults to null.
   */
  get focusTiltMax() {
  ...
  /**
   * @returns {?Array.<number>} Width, height, depth of a matrix pixel in millimeters.
   */
  ...
  /**
   * @returns {?Array.<number>} XYZ-Spacing between matrix pixels in millimeters.
   */
