...
class Physical {
  ...
  /**
   * @returns {boolean|null} Whether physical data about the focus is available.
   */
  get hasFocus() {
  ...
  /**
   * @returns {number|null} The maximum angle in degrees that this fixture can rotate in horizontal direction (Pan). `Number.POSITIVE_INFINITY` if continuous pan is possible. Defaults to null.
   */
  get focusPanMax() {
  ...
  /**
   * @returns {number|null} The maximum angle in degrees that this fixture can rotate in vertical direction (Tilt). `Number.POSITIVE_INFINITY` if continuous pan is possible. Defaults to null.
   */
  get focusTiltMax() {
