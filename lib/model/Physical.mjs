...
export default class Physical {
  ...
  /**
   * @returns {?boolean} Whether there is physical data about the light source available.
   */
  get hasBulb() {
  ...
  /**
   * @returns {?boolean} Whether there is physical data about the lens available.
   */
  get hasLens() {
  ...
  /**
   * @returns {?boolean} Whether there is physical data about the focus available.
   */
  get hasFocus() {
