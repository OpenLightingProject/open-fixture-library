...
export default class Capability {
  ...
  /**
   * @returns {'Open'|'Closed'|'Strobe'|'StrobeRandom'|'Pulse'|'PulseRandom'|'RampUp'|'RampUpRandom'|'RampDown'|'RampDownRandom'|'RampUpDown'|null} Behavior for the shutter. Defaults to null.
   */
  get shutterEffect() {
