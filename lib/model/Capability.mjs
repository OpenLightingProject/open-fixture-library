...
const namePerType = {
  ...
  StrobeSpeed: cap =>
    `Strobe speed ${appendComment(startEndToString(cap.speed), cap.comment)}`,
  StrobeDuration: cap =>
    `Strobe duration ${appendComment(startEndToString(cap.duration), cap.comment)}`
};
