...
const START_END_PROPERTIES = [`speed`, `duration`, `brightness`, `index`, `angle`, `colorTemperature`, `effectIntensity`, `soundSensitivity`, `distance`, `openPercent`, `frostIntensity`, `insertion`, `fogOutput`, `parameter`];
