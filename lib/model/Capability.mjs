...
const namePerType = {
  ...
  ColorWheelRotation: cap => {
    const angleOrSpeed = cap.angle !== null ? `angle` : `speed`;
    return appendInBrackets(`Color wheel rotation ${startEndToString(cap[angleOrSpeed], angleOrSpeed)}`, cap.comment);
  },
  ...
  GoboStencilRotation: cap => {
    const angleOrSpeed = cap.angle !== null ? `angle` : `speed`;
    return appendInBrackets(`Gobo stencil rotation ${startEndToString(cap[angleOrSpeed], angleOrSpeed)}`, cap.comment);
  },
  GoboWheelRotation: cap => {
    const angleOrSpeed = cap.angle !== null ? `angle` : `speed`;
    return appendInBrackets(`Gobo wheel rotation ${startEndToString(cap[angleOrSpeed], angleOrSpeed)}`, cap.comment);
  },
  Focus: cap => {
  ...
  PrismRotation: cap => {
    const angleOrSpeed = cap.angle !== null ? `angle` : `speed`;
    return appendInBrackets(`Prism rotation ${startEndToString(cap[angleOrSpeed], angleOrSpeed)}`, cap.comment);
  },
  BladeInsertion: cap => {
  ...
  Rotation: cap => {
    const angleOrSpeed = cap.angle !== null ? `angle` : `speed`;
    return appendInBrackets(`Rotation ${startEndToString(cap[angleOrSpeed], angleOrSpeed)}`, cap.comment);
  },
  Speed: cap => {
