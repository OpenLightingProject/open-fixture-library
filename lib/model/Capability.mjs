...
const namePerType = {
  ...
  RotationAngle: cap => {
    return appendInBrackets(`Rotation ${startEndToString(cap.angle, `angle`)}`, cap.comment);
  },
  RotationSpeed: cap => {
    return appendInBrackets(`Rotation ${startEndToString(cap.speed, `speed`)}`, cap.comment);
  },
  Speed: cap => {
