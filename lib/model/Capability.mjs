...
const namePerType = {
  ...
  StrobeSpeed: cap =>
    appendInBrackets(`Strobe speed ${startEndToString(cap.speed)}`, cap.comment),
  StrobeDuration: cap =>
    appendInBrackets(`Strobe duration ${startEndToString(cap.duration)}`, cap.comment),
  Intensity: cap =>
    appendInBrackets(`Intensity ${startEndToString(cap.brightness)}`, cap.comment),
  ColorIntensity: cap =>
    appendInBrackets(`${cap.color} ${startEndToString(cap.brightness)}`, cap.comment),
  ColorPreset: cap => {
  ...
  ColorWheelRotationAngle: cap =>
    appendInBrackets(`Color wheel rotation ${startEndToString(cap.angle, `angle`)}`, cap.comment),
  ColorWheelRotationSpeed: cap =>
    appendInBrackets(`Color wheel rotation ${startEndToString(cap.speed, `speed`)}`, cap.comment),
  Pan: cap =>
    appendInBrackets(`Pan ${startEndToString(cap.angle, `angle`)}`, cap.comment),
  PanContinuous: cap =>
    appendInBrackets(`Continuous pan ${startEndToString(cap.speed, `speed`)}`, cap.comment),
  Tilt: cap =>
    appendInBrackets(`Tilt ${startEndToString(cap.angle, `angle`)}`, cap.comment),
  TiltContinuous: cap =>
    appendInBrackets(`Continuous tilt ${startEndToString(cap.speed, `speed`)}`, cap.comment),
  PanTiltSpeed: cap => {
  ...
  EffectSpeed: cap =>
    appendInBrackets(`Effect speed ${startEndToString(cap.speed)}`, cap.comment),
  EffectDuration: cap =>
    appendInBrackets(`Effect duration ${startEndToString(cap.duration)}`, cap.comment),
  EffectIntensity: cap =>
    appendInBrackets(`Effect intensity ${startEndToString(cap.effectIntensity)}`, cap.comment),
  SoundSensitivity: cap =>
    appendInBrackets(`Sound sensitivity ${startEndToString(cap.sensitivity)}`, cap.comment)
};
