...
export default class Capability {
  ...
  get isStep() {
    if (!(`isStep` in this._cache)) {
      this._cache.isStep = Capability.START_END_ENTITIES.every(
        prop => this[prop] === null || this[prop][0].number === this[prop][1].number
      );
    }
  ...
  get isInverted() {
    if (!(`isInverted` in this._cache)) {
      if (this.isStep) {
        ...
        const proportionalProps = Capability.START_END_ENTITIES.filter(
          prop => this[prop] !== null && this[prop][0].number !== this[prop][1].number
        );
