...
class Capability {
   ...
   * @returns {any[] | null} Start and end value of the property (may be equal), parsed to Entity instances. null if it isn't defined in JSON.
   */
 ...
 * @param {...any} inBrackets Strings that should be added in brackets to the given original string. Invalid strings are ignored.
...
/**
 * @ignore
 * @param {string[]} colorTemperature Start and end entities of color temperature.
