...
const namePerType = {
  ...
  WheelSlotRotation: capability => {
    ...
    return getSimpleCapabilityName(`${wheelSlotName} rotation`, speedOrAngle, speedOrAngle, true);
  },
  ...
  FogType: capability => getSimpleCapabilityName(capability, `Fog type:`, `fogType`),
  Rotation: capability => {
    const speedOrAngle = capability.speed !== null ? `speed` : `angle`;
