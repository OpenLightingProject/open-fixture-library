...
/**
 * A company or brand that produces fixture. Each fixture is associated to a manufacturer.
 */
export default class Manufacturer {
  /**
   * Creates a new Manufacturer instance.
   * @param {!string} key The manufacturer key. Equals the directory name in the fixtures directory.
   */
  constructor(key) {
    this.key = key;
  }
