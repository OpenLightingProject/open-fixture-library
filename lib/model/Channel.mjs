...
const channelTypeConstraints = {
  ...
  'Multi-Color': [`ColorPreset`, `ColorWheelIndex`, `ColorWheelRotationAngle`],
  'Pan': [`Pan`, `PanContinuous`],
  'Tilt': [`Tilt`, `TiltContinuous`],
  'Focus': [`Focus`],
  'Zoom': [`Zoom`],
  'Iris': [`Iris`, `IrisEffect`],
  'Gobo': [`GoboIndex`, `GoboShake`, `GoboStencilRotationAngle`, `GoboWheelRotationAngle`],
  'Prism': [`PrismOff`, `PrismOn`, `PrismRotationAngle`],
  'Effect': [`Effect`, `EffectIntensity`, `EffectDuration`, `Frost`, `FrostEffect`, `SoundSensitivity`],
  'Color Temperature': [`ColorTemperature`],
  'Shutter': [`ShutterStrobe`, `BladeInsertion`, `BladeRotation`, `BladeSystemRotation`],
  'Strobe': [`StrobeDuration`],
  'Fog': [`FogOff`, `FogOn`, `FogOutput`, `FogType`],
  'Speed': [`StrobeSpeed`, `ColorWheelRotationSpeed`, `PanTiltSpeed`, `EffectSpeed`, `GoboStencilRotationSpeed`, `GoboWheelRotationSpeed`, `PrismRotationSpeed`, `RotationSpeed`, `Speed`, `Time`],
  'Maintenance': [`Maintenance`],
  'Intensity': [`Intensity`, `RotationAngle`, `BeamAngle`, `Generic`],
  'Nothing': [`Nothing`]
};
