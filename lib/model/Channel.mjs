...
const channelTypeConstraints = {
  ...
  'Speed': [`StrobeSpeed`, `ColorWheelRotationSpeed`, `PanTiltSpeed`, `EffectSpeed`, `GoboStencilRotationSpeed`, `GoboWheelRotationSpeed`, `PrismRotationSpeed`, `RotationSpeed`, `Speed`],
