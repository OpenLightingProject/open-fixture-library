...
const channelTypeConstraints = {
  ...
  'Speed': [`StrobeSpeed`, `ColorWheelRotation`, `PanTiltSpeed`, `EffectSpeed`, `GoboStencilRotationSpeed`, `GoboWheelRotationSpeed`, `PrismRotationSpeed`, `RotationSpeed`, `Speed`, `Time`],
