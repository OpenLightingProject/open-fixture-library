...
const channelTypeConstraints = {
  ...
  'Speed': [`StrobeSpeed`, `ColorWheelRotation`, `PanTiltSpeed`, `EffectSpeed`, `GoboStencilRotation`, `GoboWheelRotation`, `PrismRotation`, `Rotation`, `Speed`, `Time`],
...
export default class Channel extends AbstractChannel {
  ...
  get canCrossfade() {
    if (!(`canCrossfade` in this._cache)) {
      this._cache.canCrossfade = this.capabilities.length === 1 && !this.capabilities[0].isStep;
    }
