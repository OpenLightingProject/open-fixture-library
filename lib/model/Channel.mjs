...
export default class Channel extends AbstractChannel {
  /**
   * @returns {!Fineness} Fineness of an 8bit channel.
   */
  static get FINENESS_8BIT() {
    return 1;
  }

  /**
   * @returns {!Fineness} Fineness of an 16bit channel.
   */
  static get FINENESS_16BIT() {
    return 2;
  }

  /**
   * @returns {!Fineness} Fineness of an 24bit channel.
   */
  static get FINENESS_24BIT() {
    return 3;
  }

  /**
   * @returns {!Fineness} Fineness of an 32bit channel.
   */
  static get FINENESS_32BIT() {
    return 4;
  }
    ...
    if (!(`dmxValueResolution` in this._cache)) {
      if (`dmxValueResolution` in this._jsonObject) {
        const resolutionStringToFineness = {
          '8bit': Channel.FINENESS_8BIT,
          '16bit': Channel.FINENESS_16BIT,
          '24bit': Channel.FINENESS_24BIT
        };
  ...
  getDefaultValueWithFineness(fineness) {
    if (fineness > this.maxFineness || fineness < Channel.FINENESS_8BIT || fineness % 1 !== 0) {
