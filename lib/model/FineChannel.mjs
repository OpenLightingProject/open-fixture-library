...
export default class FineChannel extends AbstractChannel {
  ...
  get name() {
    return `${this.coarseChannel.name} fine${this.fineness > Channel.FINENESS_16BIT ? `^${this.fineness - 1}` : ``}`;
  }
  ...
  get coarserChannel() {
    return this.fineness === Channel.FINENESS_8BIT ? this.coarseChannel : this.coarseChannel.fineChannels[this.fineness - 2];
  }
