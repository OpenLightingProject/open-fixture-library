  ...
  get switchingChannels() {
    if (!('switchingChannels' in this._cache)) {
      ...
      if (this.capabilities.length > 0 && Object.keys(this.capabilities[0].switchChannels).length > 0) {
        for (const switchingChannelKey of Object.keys(this.capabilities[0].switchChannels)) {
          channels[switchingChannelKey] = new SwitchingChannel(switchingChannelKey, this);
        }
      }
