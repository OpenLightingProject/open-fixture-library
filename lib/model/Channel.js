...
module.exports = class Channel extends AbstractChannel {
  ...
  /**
   * @return {!Capability[]} All capabilities of this channel, ordered by range. Defaults to a 0-100% capability
   */
  get capabilities() {
    if (!('capabilities' in this._cache)) {
      if (this.hasCapabilities) {
        /** @type {!Fineness} Calculate how fine the capabilties are defined.  */
        const fineness = (this._jsonObject.capabilities[this._jsonObject.capabilities.length - 1].range[1]+1) / 256 - 1;
