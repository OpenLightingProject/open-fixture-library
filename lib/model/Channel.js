...
module.exports = class Channel extends AbstractChannel {
  ...
  /**
   * @returns {!Fineness} How fine the channel is declared. Equals the amout of fine channels.
   */
  get maxFineness() {
  ...
  /**
   * @returns {!Array.<Capability>} All capabilities of this channel, ordered by range. Defaults to a 0-100% capability
   */
  get capabilities() {
