...
class WheelSlot {
  ...
  get type() {
    if (!(`type` in this._cache)) {
      ...
      else if (this._floorSlot.type === `AnimationGoboStart`) {
   ...
   */
  get resource() {
    if (!(`resource` in this._cache)) {
      if (this.isSplitSlot || !(`resource` in this._jsonObject)) {
        this._cache.resource = null;
      }
      else if (typeof this._jsonObject.resource === `string`) {
        this._cache.resource = this._jsonObject.resource;
      }
      else {
        this._cache.resource = new Resource(this._jsonObject.resource);
      }
    }
  ...
  get colorTemperature() {
    if (!(`colorTemperature` in this._cache)) {
      this._cache.colorTemperature = `colorTemperature` in this._jsonObject
        ? Entity.createFromEntityString(this._jsonObject.colorTemperature)
        : null;
    }
  ...
  get openPercent() {
    if (!(`openPercent` in this._cache)) {
      this._cache.openPercent = `openPercent` in this._jsonObject
        ? Entity.createFromEntityString(this._jsonObject.openPercent)
        : null;
    }
  ...
  get frostIntensity() {
    if (!(`frostIntensity` in this._cache)) {
      this._cache.frostIntensity = `frostIntensity` in this._jsonObject
        ? Entity.createFromEntityString(this._jsonObject.frostIntensity)
        : null;
    }
