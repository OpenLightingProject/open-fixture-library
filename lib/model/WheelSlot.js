...
class WheelSlot {
  ...
  /**
   * @returns {Object|null} The gobo resource object, or null if no resource is specified for the slot.
   */
  get resource() {
    return this.isSplitSlot ? null : (this._jsonObject.resource || null);
  }
