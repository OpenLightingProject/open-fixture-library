...
module.exports = class Matrix {
  ...
  /**
   * @returns {!Array.<number>} Amount of pixels in x, y and z direction.
   */
  get pixelCount() {
  ...
  /**
   * @returns {!Array.<string>} All pixelKeys.
   */
  get pixelKeys() {
    return Object.keys(this.pixelKeyPositions);
  }
   ...
   * 3D         "($x, $y, $z)"
   *
   * @param {!number} x Index of pixel in x direction.
   * @param {!number} y Index of pixel in y direction.
   * @param {!number} z Index of pixel in z direction.
