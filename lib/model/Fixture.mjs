...
export default class Fixture {
  ...
  /**
   * @returns {?object.<string, array>} An object with URL arrays, organized in categories, or null if no links are available for this fixture.
   */
  get links() {
  ...
  /**
   * @param {!string} category The category of the links that should be returned.
   * @returns {!array.<string>} An array of URLs of the specified category (may be empty).
   */
  getLinksInCategory(category) {
    if (this.links === null) {
      return [];
    }
  ...
  /**
   * Used as reference for all the information included in this fixture.
   * @returns {?string} The first manual URL present in the fixture, or null if there is no manual URL available for this fixture.
   */
  get manualURL() {
    return this.getLinksInCategory(`manual`)[0] || null;
  }
