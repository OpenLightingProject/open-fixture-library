...
export default class Fixture {
  ...
  /**
   * @returns {?object.<string, array>} An object with URL arrays, organized by link type, or null if no links are available for this fixture.
   */
  get links() {
  ...
  /**
   * @returns {?Physical} The general physical information for the fixture, may be overridden by modes.
   */
  get physical() {
  ...
  /**
   * @returns {!Array.<string>} Coarse channels' keys, including matrix channels. If possible, ordered by appearance.
   */
  ...
  /**
   * @returns {!Array.<Channel>} Coarse channels, including matrix channels. If possible, ordered by appearance.
   */
  ...
  /**
   * @returns {!Array.<string>} All fine channels' aliases, including matrix channels. If possible, ordered by appearance.
   */
  ...
  /**
   * @returns {!Array.<FineChannel>} All fine channels, including matrix channels. If possible, ordered by appearance.
   */
  get fineChannels() {
  ...
  /**
   * @returns {!Array.<string>} All switching channels' aliases, including matrix channels. If possible, ordered by appearance.
   */
  ...
  /**
   * @returns {!Array.<SwitchingChannel>} All switching channels, including matrix channels. If possible, ordered by appearance.
   */
   ...
   * @returns {!Array.<string>} All template channel keys, If possible, ordered by appearance.
   */
  ...
  /**
   * Template channels are used to automatically generate channels (currently only matrix channels).
   * @returns {!Array.<TemplateChannel>} TemplateChannel instances for all template channels, If possible, ordered by appearance.
   */
   ...
   * @returns {!Array.<AbstractChannel>} All channels with pixelKey information (including fine and switching channels).
   */
  get matrixChannels() {
    if (this.matrix === null) {
      return [];
  ...
  /**
   * @returns {!Array.<string>} All channel keys used in this fixture, including matrix channels. If possible, ordered by appearance.
   */
  get allChannelKeys() {
  ...
  /**
   * @returns {!Array.<AbstractChannel>} All channels used in this fixture, including matrix channels. If possible, ordered by appearance.
   */
  get allChannels() {
  ...
  get allChannelsByKey() {
    if (!(`allChannelsByKey` in this._cache)) {
      ...
      const usedMatrixChannels = Object.values(allMatrixChannelsByKey).filter(
        matrixChannel => this.modes.some(
      ...
      usedMatrixChannels.forEach(ch => (allChannelsByKey[ch.key] = ch));
   ...
   * @returns {?AbstractChannel} The found channel, null if not found.
   */
  getChannelByKey(key) {
