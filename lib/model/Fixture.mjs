...
export default class Fixture {
  ...
  /**
   * @returns {!Array.<Channel>} Keys of available channels and matrix channels without fine or switching channel aliases.
   */
  ...
  /**
   * @returns {!Array.<Channel>} Available channels and matrix channels without fine or switching channels.
   */
  get normalizedChannels() {
    if (!(`normalizedChannels` in this._cache)) {
      ...
      const matrixChannels = this.matrixChannels.filter(
        ch => ch instanceof Channel
      );

      this._cache.normalizedChannels = availableChannels.concat(matrixChannels);
    }
  ...
  /**
   * @returns {!Array.<AbstractChannel>} All generated channels. If possible, ordered by appearance.
   */
  get allChannels() {
