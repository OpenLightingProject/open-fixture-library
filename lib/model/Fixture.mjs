...
export default class Fixture {
  ...
  /**
   * Helper function to merge array properties of all availableChannels.
   * @param {!string} property The channels' property name to merge.
   * @returns {!Array.<string>} Array of concatenated channels' property values.
   */
