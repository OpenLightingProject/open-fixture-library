...
export default class Meta {
  ...
  /**
   * @returns {?string} The key of the plugin with which this fixture was imported. Null if it's not imported.
   */
  get importPlugin() {
  ...
  /**
   * @returns {?string} When this fixture was imported. Null if it's not imported.
   */
  get importDate() {
  ...
  /**
   * @returns {?string} A comment further describing the import process. Null if it's not imported.
   */
  get importComment() {
  ...
  /**
   * @returns {?string} Whether there is an import comment. Always false if it's not imported.
   */
