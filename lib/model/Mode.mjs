import MatrixChannel from './MatrixChannel.mjs';
...
export default class Mode {
  ...
  /**
   * @returns {?Physical} Override or extend the fixture's physical data with this physical data if this mode is activated. Defaults to null.
   */
  ...
  */
  getChannelIndex(channel, switchingChannelBehaviour = `all`) {
    ...
    return this.channels.findIndex(ch => {
      ...
      if (ch instanceof MatrixChannel) {
        ch = ch.wrappedChannel;
      }
