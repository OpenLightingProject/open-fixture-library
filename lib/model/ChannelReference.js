...
module.exports = class ChannelReference {
   ...
   * @param {*} templateKey The template channel's key.
   * @param {*} pixelKey The pixelKey or pixelGroupKey of this channel.
   */
  static fromMatrixReference(templateKey, pixelKey) {
    return new this(
      TemplateChannel.parseTemplateString(templateKey, {pixelKey: pixelKey}),
      templateKey,
      pixelKey
    )
  }
   ...
   */
  static fromMatrixInsert(matrixInsert) {
