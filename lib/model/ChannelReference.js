...
module.exports = class ChannelReference {
  ...
  /**
   * @returns {!boolean} Whether this channel has a pixelKey and therefore is a matrix channel or not.
   */
  get isMatrixChannel() {
   ...
   * @returns {!ChannelReference} The channel reference instance.
   */
   ...
   * @returns {!Array.<ChannelReference>} References to all created matrix channels.
   */
