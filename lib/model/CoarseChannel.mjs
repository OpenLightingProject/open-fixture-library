...
import { scaleDmxValue } from '../scale-dmx-values.mjs';
...
const channelTypeConstraints = {
  ...
  'Speed': [`StrobeSpeed`, `StrobeDuration`, `PanTiltSpeed`, `EffectSpeed`, `EffectDuration`, `PrismRotation`, `Rotation`, `Speed`, `Time`, `WheelSlotRotation`, `WheelRotation`, `WheelShake`],
  'Maintenance': [`Maintenance`],
  'Intensity': [`Intensity`, `BeamAngle`, `BeamPosition`, `Generic`],
