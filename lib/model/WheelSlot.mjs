...
class WheelSlot {
  ...
  /**
   * @returns {?array.<string>} The colors of this wheel slot, or null if this slot has no colors.
   */
  get colors() {
  ...
  /**
   * @returns {?Entity} For Color slots, the slot's color temperature. Null if this slot has no color temperature.
   */
  ...
  /**
   * @returns {?number} For Prism slots, the number of prism facets. Null if number of facets is not defined.
   */
  get facets() {
  ...
  /**
   * @returns {?Entity} For Iris slots, the slot's openPercent value. Null if this slot has no openPercent value.
   */
  get openPercent() {
  ...
  /**
   * @returns {?Entity} For Frost slots, the slot's frost intensity. Null if this slot has no frost intensity.
   */
  get frostIntensity() {
  ...
  /**
   * @returns {?WheelSlot} For split slots, the floor (start) slot. Null for non-split slots.
   */
  get floorSlot() {
  ...
  /**
   * @returns {?WheelSlot} For split slots, the ceil (end) slot. Null for non-split slots.
   */
  get ceilSlot() {
