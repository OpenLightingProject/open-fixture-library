...
class CoarseChannel extends AbstractChannel {
   ...
   * @param {Readonly<object>} jsonObject - The channel data from the fixture's JSON.
   * @param {Readonly<Fixture>} fixture - The fixture instance this channel is associated to.
   */
  ...
  get _defaultValuePerResolution() {
    ...
    if (!Number.isSafeInteger(rawDefaultValue)) {
  ...
  get _highlightValuePerResolution() {
    ...
    if (!Number.isSafeInteger(rawHighlightValue)) {
