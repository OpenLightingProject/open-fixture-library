...
import MatrixChannelReference from './MatrixChannelReference.mjs';
 ...
 */
export default class TemplateChannel extends Channel {
  /**
  ...
  /**
   * Creates a channel (together with its fine and switching channels if defined) from this template with the specified pixelKey. If availableChannels override this channel, that existing channel is returned.
   * @param {!string} pixelKey The channel's pixelKey or pixelGroupKey.
   * @returns {!Array.<AbstractChannel>} The generated (or existing) channel associated to the given pixel key and its fine and switching channels.
   */
