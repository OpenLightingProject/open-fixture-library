...
module.exports = class Fixture {
  constructor(key, jsonObject, man) {
    this._key = key;
  ...
  // returns an object extending AbstractChannel or returns null
  // (e.g. Channel, FineChannel, SwitchingChannel)
  getChannelByKey(key) {
  ...
  static fromRepository(man, fix) {
    ...
    return new this(fix, JSON.parse(fs.readFileSync(fixPath, 'utf8')), man);
  }
};