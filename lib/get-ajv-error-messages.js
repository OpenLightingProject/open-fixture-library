...
/**
 * @param {readonly object[]} ajvErrors - The array of AJV error objects.
...
/**
 * @param {Readonly<unknown>} data - Any kind of data; not all types can be represented.
...
function getDataDescription(data) {
  ...
  switch (typeof data) {
    ...
    case 'object': {
      return 'type' in data ? ` (type: ${data.type})` : '';
    }
    default: {
      return '';
    }
