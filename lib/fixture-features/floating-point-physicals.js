...
for (const fixtureFeature of module.exports) {
  /**
   * @param {Fixture} fixture The Fixture instance
   * @returns {Boolean} true if the fixture uses the feature
   */
  fixtureFeature.hasFeature = fixture => isFloatInPhysical(fixture.physical, fixtureFeature.properties) || fixture.modes.some(mode => isFloatInPhysical(mode.physical, fixtureFeature.properties));
}
