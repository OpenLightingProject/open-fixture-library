...
export class Register {
   ...
   * @param {Readonly<object>} manufacturers - An object of all known manufacturers like specified by the manufacturer schema.
   * @param {Readonly<object> | null} register - A register object to start with.
   */
  ...
  getAsSortedObject() {
    ...
    sortedRegister.lastUpdated = Object.keys(this.filesystem).filter(
      ...
      return actionDelta === 0 ? localeSort(fixtureKeyA, fixtureKeyB) : actionDelta;
    });
