 ...
 */
module.exports.export = async function exportDragonframeLight(fixtures, options) {
  ...
  return [{
    name: `dragonframe_fixture_library.json`,
    content: fixtureJsonStringify(library),
    mimetype: `application/dragonframe-fixture-library`,
    fixtures,
  }];
};
