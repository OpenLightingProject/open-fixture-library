<template>
  <div class="capability-type-data">
    ...
    <LabeledInput
      ...
      label="Slot number"
      hint="Use 1.5 to indicate a wheel position halfway between slots 1 and 2. Leave the slot number empty if this capability doesn't select a wheel slot, but only activates wheel slot rotation for a WheelSlot capability in another channel."
