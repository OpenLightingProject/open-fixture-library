  ...
  <app-a11y-dialog
    ...
    <div v-else-if="submit.state === `ready`">
      ...
      <div class="button-bar right">
        ...
        <a @click.prevent="onDownload" class="button secondary">Download</a>
        <a @click.prevent="onSubmit" class="button primary">Submit</a>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    onDownload() {
      ...
      let dlAnchorElem = this.$refs.downloadAnchorElement;
