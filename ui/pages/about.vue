<template>
  <div>
    ...
    <p>In March 2018, we decided it was time to get our own server and domain, so here we are at <a href="https://open-fixture-library.org">open-fixture-library.org</a>! Of course there is still more to be improved, so feel free to contribute!</p>
